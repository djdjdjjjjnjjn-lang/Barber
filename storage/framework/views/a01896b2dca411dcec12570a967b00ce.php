...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4">
            <?php if(Route::has('password.request')): ?>
                ...
                <a class="underline text-sm text-stone-600 hover:text-stone-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500" href="<?php echo e(route('password.request')); ?>">
                    Lupa password?
                </a>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\barber\resources\views/auth/login.blade.php ENDPATH**/ ?>
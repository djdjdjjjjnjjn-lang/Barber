                    ...
                    <div class="flex items-center gap-x-4 lg:gap-x-6">
                        ...
                        <div class="relative">
                            ...
                            <span class="hidden lg:flex lg:items-center">
                                <span class="ml-4 text-sm font-semibold leading-6 text-gray-900" aria-hidden="true"><?php echo e(Auth::user()->name); ?></span>
                            </span>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\laragon\www\barber\resources\views/layouts/admin.blade.php ENDPATH**/ ?>
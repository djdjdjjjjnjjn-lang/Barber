...
<div x-data="{
    capsters: <?php echo e($capsters->map(function($capster) {
        return [
            'id' => $capster->id,
            'nama' => $capster->nama,
    ...
    selectedCapsterId: '<?php echo e(old('capster_id', $old_data['capster_id'] ?? '')); ?>',
    get selectedCapster() {
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-x-16">
                ...
                <form action="<?php echo e(route('booking.check')); ?>" method="POST">
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="mt-2.5">
                                <select id="layanan_id" name="layanan_id" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                                    ...
                                    <?php $__currentLoopData = $layanans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $layanan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($layanan->id); ?>" <?php echo e((isset($old_data['layanan_id']) && $old_data['layanan_id'] == $layanan->id) ? 'selected' : ''); ?>>
                                            <?php echo e($layanan->nama); ?> - Rp <?php echo e(number_format($layanan->harga)); ?>
                        ...
                        <div>
                            ...
                            <div class="mt-2.5">
                                <select x-model="selectedCapsterId" id="capster_id" name="capster_id" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required>
                                    ...
                                    <?php $__currentLoopData = $capsters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $capster): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($capster->id); ?>" <?php echo e((isset($old_data['capster_id']) && $old_data['capster_id'] == $capster->id) ? 'selected' : ''); ?>>
                                            <?php echo e($capster->nama); ?>
                        ...
                        <div>
                            ...
                            <div class="mt-2.5">
                                <input type="date" name="tanggal_booking" id="tanggal_booking" min="<?php echo e(date('Y-m-d')); ?>" class="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" required value="<?php echo e($old_data['tanggal_booking'] ?? ''); ?>">
                            </div>
                        </div>
                    </div>
                    <div class="mt-10">
            ...
            <div class="mt-10 md:mt-0">
                ...
                <div class="mt-8 bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <form action="<?php echo e(route('booking.store')); ?>" method="POST" class="mt-6">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="nama_pelanggan" value="<?php echo e($old_data['nama_pelanggan']); ?>">
                        <input type="hidden" name="no_hp_pelanggan" value="<?php echo e($old_data['no_hp_pelanggan']); ?>">
                        <input type="hidden" name="layanan_id" value="<?php echo e($old_data['layanan_id']); ?>">
                        <input type="hidden" name="capster_id" value="<?php echo e($old_data['capster_id']); ?>">
                        <input type="hidden" name="tanggal_booking" value="<?php echo e($old_data['tanggal_booking']); ?>">
                        
                        <?php if(count($available_slots) > 0): ?>
                            <fieldset>
                                <legend class="sr-only">Pilih Jam</legend>
                                <div class="grid grid-cols-3 sm:grid-cols-4 gap-3">
                                    <?php $__currentLoopData = $available_slots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $slot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div>
                                            <input type="radio" name="jam_booking" id="slot_<?php echo e($loop->index); ?>" value="<?php echo e($slot); ?>" class="sr-only peer" required>
                                            <label for="slot_<?php echo e($loop->index); ?>" class="block w-full text-center cursor-pointer rounded-md border border-gray-300 p-3 text-sm font-medium text-gray-700 hover:bg-gray-50 peer-checked:bg-indigo-600 peer-checked:text-white peer-checked:border-indigo-600 transition-colors"><?php echo e($slot); ?></label>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </fieldset>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\barber\resources\views/booking/create.blade.php ENDPATH**/ ?>